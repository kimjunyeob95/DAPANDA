      ...
      if (depth == 0) {
        ...
        if (depth == 0) {
          category2 = categoryList.filter((c) => {
            return c.category1 == this.category1[0]
          })
          this.cate1 = this.category1[0]
        }
        ...
        this.cate2 = this.category2[0]

        let category3 = []
        category3 = categoryList.filter((c) => {
          return c.category1 == this.category1[0] && c.category2 == category2[0]
        })
        let oCategory3 = {}
